...
cd /workspace/ComfyUI/custom_nodes/ComfyUI-Advanced-ControlNet
pip3 install -r requirements.txt
...
cd /workspace/ComfyUI/custom_nodes/comfyui-inpaint-nodes
pip3 install -r requirements.txt
...
cd /workspace/ComfyUI/custom_nodes/ComfyUI-segment-anything-2   
pip3 install -r requirements.txt
